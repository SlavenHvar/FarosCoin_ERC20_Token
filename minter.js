...
async function BuyFAROS(amount) {
  try {
    ...
    function addTokenMetamask()//change
    {
        ...
        window.ethereum.request({
          ...
          options: {
            address: "0xEaC4c075f20886BB8bBc2998fB59FEB6a62b04fE", // The address that the token is at. //
            symbol: "FAROS", // A ticker symbol or shorthand, up to 5 chars.
            decimals: 2, // The number of decimals in the token
            image: "https://faroscoin.com/token.png" // A string url of the token logo //*change
          },
          },
        })
        .catch((error) => {
